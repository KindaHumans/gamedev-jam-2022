...
namespace QPathFinder
{
    public class PathFollower : MonoBehaviour
    {
        ...
        protected virtual bool IsOnPoint(int pointIndex) {return enemyPathfinding.IsOnPoint(CastToVec(this._pathToFollow[pointIndex])); }//Debug.LogError("Override this"); return false; /* override this */ }
        ...
        {
            enemyPathfinding.MoveTo(CastToVec(this._pathToFollow[pointIndex]));
            /// override this 
